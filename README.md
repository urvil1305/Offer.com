...
2.	MySQL Server & MySQL Workbench (or XAMPP if you prefer phpMyAdmin)
3.	Git (to clone/pull the code)
...
3.	Run the following SQL script to create the necessary tables exactly as the backend expects them:
...
________________________________________💻 Step 3: Frontend Setup (React/Vite)
